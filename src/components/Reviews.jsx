    ...
    <div className="mx-auto max-w-7xl w-full px-4 sm:px-6 lg:px-8 my-10">
      <div className="space-y-1 mb-10">
        ...
        <h2 className="text-3xl sm:text-4xl font-normal tracking-tight leading-tight text-slate-900 dark:text-white">
          What{" "}
          <span className="font-serif italic text-slate-700 dark:text-emerald-200">
            learners
          </span>{" "}
          say
        </h2>
        ...
        {reviewData.map((item) => (
          ...
          >
            ...
            <div className="flex items-center gap-3.5 pt-2">
              <div
                className={`w-11 h-11 rounded-xl ${item.avatarBg} text-white flex items-center justify-center text-sm font-bold shadow-sm select-none`}
              >
                {item.initials}
              </div>
              <div>
